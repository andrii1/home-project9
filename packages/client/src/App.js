...
import { Errors } from './containers/Errors/Errors.Container';
import { ErrorView } from './containers/ErrorView/ErrorView.Container';
      ...
      <Router>
        <UserProvider>
          ...
          <Routes>
            ...
            <Route exact path="/blog/:slugParam" element={<ErrorView />} />
